...
#gbp servicechain-node-create --service-profile lb_profile --template-file /home/stack/magesh/lb.template haproxy_node

#gbp servicechain-node-create --service-profile fw_profile --template-file /home/stack/magesh/fw.template vyos_fw_node
