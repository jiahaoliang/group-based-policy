...
sudo cp -r $NOOP_FIREWALL_DRIVER_DIR /opt/stack/neutron-fwaas/neutron_fwaas/services/firewall/drivers/linux/.
...
sudo bash $GBP_SCRIPT_DIR/configure_oc_gbp_params.sh $GBP_SCRIPT_DIR $TOP_DIR
