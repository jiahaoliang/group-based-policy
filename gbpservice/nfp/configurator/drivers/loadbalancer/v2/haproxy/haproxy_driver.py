...
class HaproxyCommonManager(object):
    ...
    def create(self, context, obj):
        LOG.info(_LI("LB %s, create %s"), self.__class__.__name__, obj['id'])

    def update(self, context, old_obj, obj):
        LOG.info(_LI("LB %s, update %s"), self.__class__.__name__, obj['id'])

    def delete(self, context, obj):
        LOG.info(_LI("LB %s, delete %s"), self.__class__.__name__, obj['id'])
...
class HaproxyLoadBalancerManager(HaproxyCommonManager,
    ...
    def create(self, context, loadbalancer):
        LOG.info(_LI("LB %s, create %s"), self.__class__.__name__,
                 loadbalancer['id'])
    ...
    def update(self, context, old_loadbalancer, loadbalancer):
        LOG.info(_LI("LB %s, update %s"), self.__class__.__name__,
                 loadbalancer['id'])
        self.driver.add_amphora(loadbalancer['id'],
                                loadbalancer['description'])
        loadbalancer_o_obj = self.driver.o_models_builder.\
    ...
    def delete(self, context, loadbalancer):
        LOG.info(_LI("LB %s, delete %s"), self.__class__.__name__,
                 loadbalancer['id'])
    ...
    def create_and_allocate_vip(self, context, obj):
        LOG.info(_LI("LB %s, create_and_allocate_vip %s"),
...
class HaproxyPoolManager(HaproxyCommonManager,
    ...
    def create(self, context, pool):
        LOG.info(_LI("LB %s, create %s"), self.__class__.__name__, pool['id'])
        self._deploy(pool)

    def update(self, context, old_pool, pool):
        LOG.info(_LI("LB %s, update %s"), self.__class__.__name__, pool['id'])
        self._deploy(pool)

    def delete(self, context, pool):
        LOG.info(_LI("LB %s, delete %s"), self.__class__.__name__, pool['id'])
...
class HaproxyMemberManager(HaproxyCommonManager,
    ...
    def create(self, context, member):
        LOG.info(_LI("LB %s, create %s"), self.__class__.__name__, member['id'])
        self._deploy(member)

    def update(self, context, old_member, member):
        LOG.info(_LI("LB %s, update %s"), self.__class__.__name__, member['id'])
        self._deploy(member)

    def delete(self, context, member):
        LOG.info(_LI("LB %s, delete %s"), self.__class__.__name__, member['id'])
...
class HaproxyHealthMonitorManager(HaproxyCommonManager,
    ...
    def create(self, context, hm):
        LOG.info(_LI("LB %s, create %s"), self.__class__.__name__, hm['id'])
        self._deploy(hm)

    def update(self, context, old_hm, hm):
        LOG.info(_LI("LB %s, update %s"), self.__class__.__name__, hm['id'])
        self._deploy(hm)

    def delete(self, context, hm):
        LOG.info(_LI("LB %s, delete %s"), self.__class__.__name__, hm['id'])
